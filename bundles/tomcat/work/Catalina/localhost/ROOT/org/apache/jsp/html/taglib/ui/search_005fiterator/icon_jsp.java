...
if (
 Validator.isNotNull(resultRowSplitterEntry.getTitle()) ) {
      out.write("\n");
      out.write("				<dt class=\"card-section-header container-fluid\">\n");
      out.write("					");
      //  liferay-ui:message
      ...
      // /html/taglib/ui/search_iterator/icon.jsp(40,5) name = key type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      ...
      out.write("		");
if (
 i == (resultRowSplitterEntries.size() - 1) ) {
      out.write("\n");
      out.write("			<dd></dd>\n");
      out.write("		");
}
