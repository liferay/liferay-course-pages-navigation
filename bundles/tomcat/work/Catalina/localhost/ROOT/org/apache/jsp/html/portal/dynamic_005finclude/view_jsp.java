 ...
 */
package org.apache.jsp.html.portal.dynamic_005finclude;
...
public final class view_jsp extends org.apache.jasper.runtime.HttpJspBase
	...
	private static final String _ALERT_START =
		"Liferay.Util.openToast({\n\tautoClose: false, container: document" +
			".querySelector('#controlMenuAlertsContainer'),\n\tmessage: '";
...
if (
 permissionChecker.isOmniadmin() ) {
      ...
      out.write('	');
if (
 GetterUtil.getBoolean(PropsUtil.get("license.show.lcs.notifications"), true) ) {
      out.write("\n");
      out.write("\n");
      out.write("		");
      ...
      out.write("		");
if (
 Validator.isNotNull(lcsNotificationMessage) ) {
      out.write("\n");
      out.write("			");
 _showAlert(HtmlUtil.escape(lcsNotificationMessage), pageContext); 
	...
	if ((licenseProperties != null) && !licenseProperties.isEmpty()) {
      ...
      out.write("		");
if (
 productId.equals("Portal") && Validator.isNotNull(clusterGracePeriodMessage) ) {
      out.write("\n");
      out.write("			");
 _showAlert(HtmlUtil.escape(clusterGracePeriodMessage), pageContext); 
      ...
      out.write("		");
if (
 productId.equals("Portal") && (((lifetimeDays == 30) && (expirationDays < 7)) || ((lifetimeDays > 30) && (expirationDays < 30))) && (postponeDate <= now) ) {
      out.write("\n");
      out.write("			");
      //  liferay-util:buffer
      ...
      // /html/portal/dynamic_include/view.jsp(57,3) name = var type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
...
if (
 expirationDays <= 0 ) {
          out.write("\n");
          out.write("						Your <a class=\"alert-link\" href=\"");
          out.print( themeDisplay.getPathMain() );
          out.write("/portal/license\">activation key</a> expired ");
          ...
          out.write("\n");
          out.write("						Update your <a class=\"alert-link\" href=\"");
          out.print( themeDisplay.getPathMain() );
          out.write("/portal/license\">activation key</a> because it will expire in ");
          out.print( expirationDays );
          out.write(" days.\n");
          out.write("\n");
          out.write("						");
if (
 accountEntryName.equals("Liferay Trial") ) {
          out.write("\n");
          out.write("							Visit <a class=\"alert-link\" href=\"http://www.liferay.com/c/portal/license\">your profile page at Liferay.com</a> to upgrade your trial license.\n");
          out.write("						");
}
          out.write("\n");
          out.write("\n");
...
if (
 now < (expirationDate - 3 * Time.DAY) ) {
          ...
          out.write("\n");
          out.write("\n");
          out.write("							<a class=\"alert-link\" id=\"extendExpirationReminder\" onclick=\"");
          out.print( taglibPostponeOnClick );
          out.write("\">Remind me later.</a>\n");
          out.write("						");
}
          out.write("\n");
          out.write("\n");
